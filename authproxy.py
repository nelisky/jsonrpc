...
class AuthServiceProxy(object):
    def __init__(self, serviceURL, serviceName=None, parseFloat=decimal.Decimal):
        self.__serviceURL = serviceURL
        self.__serviceName = serviceName
        self.__url = urlparse.urlparse(serviceURL)
        self.__parseFloat = parseFloat
    ...
    def __getattr__(self, name):
        ...
        return AuthServiceProxy(self.__serviceURL, name, self.__parseFloat)
    ...
    def __call__(self, *args):
        ...
        resp = json.loads(httpresp.read(), parse_float=self.__parseFloat)
        #print resp
        if resp['error'] != None:
            print resp
